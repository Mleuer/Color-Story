...
import Profile from "../Images/ColorStoryProfile.png";
    ...
    return (
        <div>
            <Grid container spacing={2} direction="row">
                <Grid item xs={8}>
                    <Grid container direction="column">
                        <Paper className={classes.text}>
                            ...
                            favorite color. Or two, or three...<br></br>
                            ...
                            free platform for those who make creative work from a variety of media and want ONE website to show it all off! It's also for users to visit and browse your work by scrolling through the Color Wall, which displays as a beautiful quilt of objects, designs, illustrations...whatever visual art you would like to share. For those who want to browse by color, the Color Wall can become a monochromatic experience with the click of a button.
                                </Typography>
                        </Paper>
                        <Paper className={classes.text}>
                            <Typography>
                ...
                <Grid item xs={4}>
                    <Grid container direction="column">
                        <img className={classes.image} src={ColorWallModal} />
